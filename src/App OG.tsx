        ...
        return (
          <div className="app-container flex h-screen">
            ...
            <div className="sidebar w-1/4 bg-gray-100 p-4">
              <h2 className="text-xl font-bold mb-4">Upload RFP</h2>
              ...
              <button onClick={handleSubmit} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded w-full">
                Generate Response
              </button>
            </div>

            {/* Main Content Area - Generated Response */}
            <div className="main-content flex-1 p-4">
              <h2 className="text-2xl font-bold mb-4">Generated RFP Response</h2>
                <textarea
                  id="response-content"
                    value={response || ""}
                    onChange={(e) => setResponse(e.target.value)} // Makes it editable
                    className="border p-4 w-full h-full rounded"
                  />
                </div>
              </div>
            );
